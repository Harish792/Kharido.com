...
const importData = async () => {
  try {
    ...
    const harishPassword = await bcrypt.hash('Harish@132', salt);
    const karanPassword = await bcrypt.hash('bosskaran', salt);
    
    await User.create({
      name: 'Harish Pathak',
      userName: 'harishpathak',
      email: 'harishpathak2003@gmail.com',
    ...
    await User.create({
      name: 'karanchauhan',
      userName: 'karanchauhan',
      email: 'karanchauhan.dev@gmail.com',
