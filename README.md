<div align="center">
  ...
  <h1>kharido- Full-Stack MERN E-Commerce App</h1>
...
npm run seed
```
> **Seed Admin Access:** Email: `admin@kharido.com` | Password: `password123`
...
This repository includes a fully-scaffolded API testing toolkit: **`kharido_Collection.json`**. 
